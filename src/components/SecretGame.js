  ...
  return (
    <div className="gameContainer">
        ...
        <div className="controls">
            ...
            <p>Найдите отель PetHome, чтобы закончить игру</p>
        </div>
        ...
        {gameOver && (
            <div className="gameOver">
                ...
                <div className="victoryText">Поздравляем! Вы победили!</div>
                <button className="restartButton" onClick={() => window.location.reload()}>Начать заново</button>
            </div>
        )}
    </div>
  );
